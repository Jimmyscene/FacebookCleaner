...
<<<<<<< HEAD
	...
	function retryAccess() {
		chrome.storage.sync.remove("AccessGranted", function() {
			chrome.extension.getBackgroundPage().initBackground();
		});
	}
...
<<<<<<< HEAD
	...
	function noAccessContainer() {
		var container = $("<div/>")
			...
			.text("You have not allowed Post Cleaner access to your Facebook Account. The extension will not work without it.")
		var button  = $("<button/>")
						.addClass("btn")
